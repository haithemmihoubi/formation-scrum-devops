#!/usr/bin/env python3
"""Assemble les modules Markdown du cours Monitoring en un seul PDF stylé."""
import re
import subprocess
import sys
import markdown
...
FILES = [
    "00-introduction.md",
    "01-prometheus-architecture.md",
    "02-metriques.md",
    "03-promql.md",
    "04-grafana.md",
    "05-alerting.md",
    "06-pratique-checklist.md",
]
...
@page {
    ...
    @top-left { content: "Monitoring avec Prometheus & Grafana"; font-size: 8pt; color: #888; }
    @top-right { content: "Formateur : Haithem Mihoubi"; font-size: 8pt; color: #e6522c; font-weight: bold; }
...
h1 { color: #c0392b; font-size: 22pt; border-bottom: 3px solid #e6522c; padding-bottom: 6px; page-break-before: always; }
h2 { color: #c0392b; font-size: 15pt; margin-top: 1.4em; border-bottom: 1px solid #d0d7de; padding-bottom: 3px; }
h3 { color: #b45309; font-size: 12.5pt; margin-top: 1.1em; }
...
th { background: #e6522c; color: white; padding: 5px 8px; text-align: left; }
td { border: 1px solid #d0d7de; padding: 4px 8px; }
tr:nth-child(even) { background: #f6f8fa; }
blockquote { border-left: 4px solid #b45309; background: #fff8c5; margin: 0.6em 0; padding: 6px 12px; color: #5b4708; }
...
.cover h1 { border: none; font-size: 30pt; page-break-before: avoid; color: #c0392b; }
.cover .sub { font-size: 14pt; color: #57606a; margin-top: 12px; }
.cover .badge { display:inline-block; background:#e6522c; color:#fff; font-size:11pt; padding:5px 16px; border-radius:20px; margin-top:24px; }
.cover .formateur { font-size: 13pt; color: #c0392b; font-weight: bold; margin-top: 44px; }
...
.toc a { color: #c0392b; text-decoration: none; display: flex; }
.toc a::after { content: target-counter(attr(href), page); color: #888; margin-left: auto; padding-left: 8px; font-size: 10pt; }
.toc .num { color: #b45309; font-weight: bold; margin-right: 8px; min-width: 34px; }
...
def main():
    ...
    cover = """
    <div class="cover">
      <h1>Monitoring avec<br>Prometheus &amp; Grafana</h1>
      <div class="sub">Métriques, PromQL, dashboards &amp; alerting — superviser ses applications</div>
      <div class="badge">Formation DevOps &bull; avec illustrations</div>
      <div class="formateur">Formateur : Haithem Mihoubi</div>
      <div class="meta">7 modules &bull; fil rouge : superviser nginx &bull; 2026</div>
    </div>
    """
    ...
    out = BASE / "Cours-Monitoring-Prometheus-Grafana.pdf"
