#!/usr/bin/env python3
"""Assemble les modules Markdown du cours Helm en un seul PDF stylé."""
import re
import subprocess
import sys
import markdown
...
FILES = [
    "00-introduction.md",
    "01-concepts.md",
    "02-structure-chart.md",
    "03-templates-values.md",
    "04-releases.md",
    "05-dependances-repos.md",
...
@page {
    ...
    @top-left { content: "Packager Kubernetes avec Helm"; font-size: 8pt; color: #888; }
    @top-right { content: "Formateur : Haithem Mihoubi"; font-size: 8pt; color: #0f1689; font-weight: bold; }
...
h1 { color: #0f1689; font-size: 22pt; border-bottom: 3px solid #0f1689; padding-bottom: 6px; page-break-before: always; }
h2 { color: #0f1689; font-size: 15pt; margin-top: 1.4em; border-bottom: 1px solid #d0d7de; padding-bottom: 3px; }
h3 { color: #1a7f37; font-size: 12.5pt; margin-top: 1.1em; }
a { color: #0f1689; text-decoration: none; }
...
th { background: #0f1689; color: white; padding: 5px 8px; text-align: left; }
...
.cover h1 { border: none; font-size: 30pt; page-break-before: avoid; color: #0f1689; }
.cover .sub { font-size: 14pt; color: #57606a; margin-top: 12px; }
.cover .badge { display:inline-block; background:#0f1689; color:#fff; font-size:11pt; padding:5px 16px; border-radius:20px; margin-top:24px; }
.cover .formateur { font-size: 13pt; color: #0f1689; font-weight: bold; margin-top: 44px; }
...
.toc a { color: #0f1689; text-decoration: none; display: flex; }
...
def main():
    ...
    cover = """
    <div class="cover">
      <h1>Packager Kubernetes<br>avec Helm</h1>
      <div class="sub">Charts, values, templates &amp; releases — déployer et versionner ses applications K8s</div>
      <div class="badge">Formation DevOps &bull; avec illustrations</div>
      <div class="formateur">Formateur : Haithem Mihoubi</div>
      <div class="meta">7 modules &bull; fil rouge : un chart nginx &bull; 2026</div>
    </div>
    """
    ...
    out = BASE / "Cours-Helm-Kubernetes.pdf"
