#!/usr/bin/env python3
"""Assemble les modules Markdown du cours GitHub Actions en un seul PDF stylé.

Pré-requis : pip install markdown weasyprint
Les illustrations SVG doivent être générées avant : python3 make_illustrations.py
"""
import re
import subprocess
import sys
...
FILES = [
    "00-introduction.md",
    "01-anatomie-github-actions.md",
    "02-preparer-application-angular.md",
    "03-preparer-serveur.md",
    "04-workflow-cicd-complet.md",
    "05-deploiement-ssh.md",
    "06-secrets-securite.md",
    "07-aller-plus-loin.md",
]
...
@page {
    ...
    @top-left { content: "Déployer une application Angular avec GitHub Actions"; font-size: 8pt; color: #888; }
    @top-right { content: "Formateur : Haithem Mihoubi"; font-size: 8pt; color: #2088ff; font-weight: bold; }
...
h1 { color: #0969da; font-size: 22pt; border-bottom: 3px solid #2088ff; padding-bottom: 6px; page-break-before: always; }
h2 { color: #0969da; font-size: 15pt; margin-top: 1.4em; border-bottom: 1px solid #d0d7de; padding-bottom: 3px; }
...
th { background: #0969da; color: white; padding: 5px 8px; text-align: left; }
...
.cover h1 { border: none; font-size: 30pt; page-break-before: avoid; color: #0969da; }
.cover .sub { font-size: 14pt; color: #57606a; margin-top: 12px; }
.cover .badge { display:inline-block; background:#2088ff; color:#fff; font-size:11pt; padding:5px 16px; border-radius:20px; margin-top:24px; }
.cover .formateur { font-size: 13pt; color: #0969da; font-weight: bold; margin-top: 44px; }
...
.toc a { color: #0969da; text-decoration: none; display: flex; }
...
figcaption, .caption { text-align: center; font-size: 9pt; color: #57606a; font-style: italic; margin-top: -0.4em; margin-bottom: 1em; }
"""
...
def main():
    # Régénère les illustrations si le script est présent
    ...
    cover = """
    <div class="cover">
      <h1>Déployer une application<br>Angular avec GitHub Actions</h1>
      <div class="sub">CI/CD de bout en bout : build, image Docker, registry &amp; déploiement SSH sur serveur</div>
      <div class="badge">Formation DevOps &bull; avec illustrations</div>
      <div class="formateur">Formateur : Haithem Mihoubi</div>
      <div class="meta">8 modules &bull; pipeline complet expliqué pas à pas &bull; 2026</div>
    </div>
    """
    ...
    out = BASE / "Cours-GitHub-Actions-Angular.pdf"
