#!/usr/bin/env python3
"""Assemble les modules Markdown du cours Kubernetes en un seul PDF stylé.

Pré-requis : pip install markdown weasyprint
Régénère les illustrations (make_illustrations.py) avant l'assemblage.
"""
import re
import subprocess
import sys
...
FILES = [
    ...
    "05-services.md",
    "06-configmap-secrets.md",
    "07-storage.md",
    "08-ingress.md",
    "09-pratique-checklist.md",
]
...
@page {
    ...
    @top-left { content: "Apprendre Kubernetes avec nginx"; font-size: 8pt; color: #888; }
    @top-right { content: "Formateur : Haithem Mihoubi"; font-size: 8pt; color: #326ce5; font-weight: bold; }
...
h1 { color: #1a4fb4; font-size: 22pt; border-bottom: 3px solid #326ce5; padding-bottom: 6px; page-break-before: always; }
h2 { color: #1a4fb4; font-size: 15pt; margin-top: 1.4em; border-bottom: 1px solid #d0d7de; padding-bottom: 3px; }
...
th { background: #326ce5; color: white; padding: 5px 8px; text-align: left; }
...
.cover h1 { border: none; font-size: 30pt; page-break-before: avoid; color: #1a4fb4; }
.cover .sub { font-size: 14pt; color: #57606a; margin-top: 12px; }
.cover .badge { display:inline-block; background:#326ce5; color:#fff; font-size:11pt; padding:5px 16px; border-radius:20px; margin-top:24px; }
.cover .formateur { font-size: 13pt; color: #1a4fb4; font-weight: bold; margin-top: 44px; }
...
.toc a { color: #1a4fb4; text-decoration: none; display: flex; }
...
def main():
    ...
    cover = """
    <div class="cover">
      <h1>Apprendre Kubernetes<br>avec nginx</h1>
      <div class="sub">Tous les concepts essentiels expliqués pas à pas, illustrés avec une seule image : nginx</div>
      <div class="badge">Formation DevOps &bull; avec illustrations</div>
      <div class="formateur">Formateur : Haithem Mihoubi</div>
      <div class="meta">10 modules &bull; Pods, Deployments, Services, ConfigMaps, Volumes, Ingress &bull; 2026</div>
    </div>
    """
    ...
    out = BASE / "Cours-Kubernetes-nginx.pdf"
